# Docker image for mailman using the alpine template
ARG IMAGE_NAME="mailman"
ARG PHP_SERVER="mailman"
ARG BUILD_DATE="Wed Jun 19 07:04:11 AM EDT 2024"
...
ARG IMAGE_REPO="casjaysdevdocker/mailman"
...
ENV HOSTNAME="casjaysdev-mailman"
...
LABEL \
  ...
  org.opencontainers.image.url="https://hub.docker.com/r/casjaysdevdocker/mailman" \
  org.opencontainers.image.url.source="https://hub.docker.com/r/casjaysdevdocker/mailman" \
  org.opencontainers.image.vcs-type="Git" \
  org.opencontainers.image.vcs-ref="${BUILD_VERSION}" \
  org.opencontainers.image.vcs-url="https://github.com/casjaysdevdocker/mailman" \
  org.opencontainers.image.documentation="https://github.com/casjaysdevdocker/mailman" \
